...
class Pipeline():
    ...
    # Note: the type def is a string rep of the module to avoid introducing 
    # a circular dependency. See https://www.python.org/dev/peps/pep-0484/#forward-references  # noqa
